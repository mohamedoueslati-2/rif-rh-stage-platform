...
public class CandidatController {
    ...
    public ResponseEntity<CandidatResponse> register(
            @Valid @RequestBody CreateCandidatRequest request
    ) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(candidatService.register(request));
    }
    ...
    public ResponseEntity<CandidatResponse> getProfil(
        ...
        return ResponseEntity.ok(
                candidatService.getProfil(currentUser.getId())
        );
    }
    ...
    public ResponseEntity<CandidatResponse> updateProfil(
        ...
        return ResponseEntity.ok(
                candidatService.updateProfil(currentUser.getId(), request)
        );
    }
    ...
    public ResponseEntity<CandidatResponse> patchProfil(
        ...
        return ResponseEntity.ok(
                candidatService.patchProfil(currentUser.getId(), request)
        );
    }
